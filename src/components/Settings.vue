          ...
          <v-card>
            <v-card-text>
              <v-layout wrap>
                ...
                <v-flex v-if="settings.auth" xs12 sm6>
                  <v-text-field
...
export default {
  ...
  computed: {
    ...
    requiredUser() {
      return (
        (this.settings.auth && !!this.settings.username) || "This field is required."
      );
    },
    requiredPassword() {
      return (
        (this.settings.auth && !!this.settings.password) || "This field is required."
      );
    },
    ...mapGetters(["settings"])
  },
